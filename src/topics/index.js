...
export const TOPICS = {
  ...
  'frontend-web': {
    ...
    workflows: [
      ...
      { trigger: '/ui-lib/shadcn-ui-stitch', skill: 'codex-flow-shadcn-ui-stitch', purpose: 'Google Stitch-oriented shadcn/ui integration patterns for rapid design-to-component workflows' },
      ...
      { trigger: '/ui-lib/aceternity-ui', skill: 'codex-flow-aceternity-ui', purpose: 'Aceternity UI component usage patterns for high-polish React interfaces' },
      ...
      { trigger: '/tailwind/advanced-layouts', skill: 'codex-flow-tailwindcss-advanced-layouts', purpose: 'Advanced Tailwind layout composition patterns for complex responsive interfaces' },
      { trigger: '/tailwind/animations', skill: 'codex-flow-tailwindcss-animations', purpose: 'Tailwind animation patterns for performant, expressive UI motion' },
      { trigger: '/tailwind/mobile-first', skill: 'codex-flow-tailwindcss-mobile-first', purpose: 'Mobile-first Tailwind workflow for breakpoint-safe component design' },
      { trigger: '/tailwind/core-patterns', skill: 'codex-flow-tailwindcss-core', purpose: 'Core Tailwind utility architecture and class composition best practices' },
      { trigger: '/tailwind/advanced-design-systems', skill: 'codex-flow-tailwindcss-advanced-design-systems', purpose: 'Advanced Tailwind design-system token and component governance patterns' },
      { trigger: '/tailwind/responsive-darkmode', skill: 'codex-flow-tailwindcss-responsive-darkmode', purpose: 'Responsive and dark-mode implementation patterns with Tailwind CSS' },
      { trigger: '/tailwind/design', skill: 'codex-flow-tailwindcss-design', purpose: 'Tailwind-first UI design workflow for production-ready visual consistency' },
      ...
      { trigger: '/frontend/aceternity-builder', skill: 'codex-flow-frontend-aceternity', purpose: 'Frontend Aceternity integration workflow for reusable React section patterns and landing blocks' },
      ...
      { trigger: '/animation/framer-motion-best-practices', skill: 'codex-flow-framer-motion-best-practices', purpose: 'Framer Motion best practices for accessibility, performance, and maintainable motion architecture' },
      { trigger: '/animation/motion-designer', skill: 'codex-flow-motion-designer', purpose: 'Motion design workflow for narrative UI transitions, timing systems, and interaction choreography' },
      { trigger: '/animation/motion-designer-startup-os', skill: 'codex-flow-motion-designer-startup-os', purpose: 'Startup-OS motion design patterns for product storytelling and conversion-focused micro-interactions' },
